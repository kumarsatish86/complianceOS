  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Add Compliance Component</h1>
          <p className="text-muted-foreground">
            Add a new compliance component to the topic
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter the details for the new compliance component
          </CardDescription>
        </CardHeader>
        <CardContent>
